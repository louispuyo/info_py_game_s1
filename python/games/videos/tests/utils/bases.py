...
class Weapons:
    ...
    bullet_degat, missile_degat, bullet_image:str, missile_image:str):
        ...
        self.bulletImg = pygame.image.load(f'/Users/snowden/Documents/COURS_L1S1/option_info/python/games/img/png/{bullet_image}')
        self.missileImg = pygame.image.load(f'/Users/snowden/Documents/COURS_L1S1/option_info/python/games/img/png/{missile_image}')
